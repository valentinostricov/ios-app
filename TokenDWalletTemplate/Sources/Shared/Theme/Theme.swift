...
enum Theme {
    ...
    enum Colors {
        ...
        static let mainColor: UIColor = UIColor(red: 0.123, green: 0.215, blue: 0.426, alpha: 1.00)
        ...
        static let textOnMainColor: UIColor = UIColor(red: 0.939, green: 0.925, blue: 0.912, alpha: 1.0)
